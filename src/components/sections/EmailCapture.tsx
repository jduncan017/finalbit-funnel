      ...
      <section id="signup" className="px-6">
        <FadeIn>
          <Wrapper
            rounded="lg"
            padding="lg"
            className="mx-auto max-w-md border border-secondary-300/30 bg-secondary-300/5 text-center"
          >
            <CircleCheck
      ...
      <FadeIn>
        <div className="mx-auto max-w-md text-center">
          ...
          <p className="mb-8 text-neutral-200">
            Upload your first screenplay and get a full breakdown in minutes. No
