...
export function ProductShowcase({
  ...
  return (
    <section className="relative mb-10 mt-16 overflow-hidden md:mb-0 md:mt-40 md:[mask-image:linear-gradient(to_bottom,black_60%,rgba(0,0,0,0)_90%)] md:[-webkit-mask-image:linear-gradient(to_bottom,black_65%,rgba(0,0,0,0)_90%)]">
