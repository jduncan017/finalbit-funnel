  ...
  if (submitted) {
    return (
      <section id="demo" className="px-6">
        <Wrapper rounded="lg" padding="lg" className="mx-auto max-w-lg border border-secondary-300/30 bg-secondary-300/5 text-center">
    ...
    <section id="demo" className="px-6">
      <div className="mx-auto max-w-lg">
        ...
        <p className="mb-8 text-center text-neutral-200">
          See how FinalBit can replace your entire tool stack. Takes 30 seconds.
        </p>
        <Wrapper rounded="lg" padding="sm" className="border border-gray-400/30 bg-gray-400/20">
          <form onSubmit={handleSubmit} className="space-y-4">
            <TextInput id="name" label="Full Name" name="name" required />
            <TextInput id="email" label="Work Email" name="email" type="email" required />
            <TextInput id="studio" label="Studio / Company Name" name="studio" required />
            <Select
              id="teamSize"
              label="Team Size"
